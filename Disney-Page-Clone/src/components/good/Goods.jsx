...
import MidSectionFour from './Good'

export default function SectionFour() {
    const store = [
        {
            image: ImageOne,
            h3: `Chip & Dale birthday commemorative goods`,
            p: " "
        },
        {
            image: ImageTwo,
        ...
        {
            image: ImageThree,
            h3: `Recommended gift items for the welcome season`,
            p: ` `
        },
        {
            image: ImageFour,
    ...
    return (
        <div className="containcon4">
            <h3 id="feat">Goods featuring popular characters are available!</h3>
